        ...
        >
          ...
          >
            <div className="projectExpandable">
              <div>
                <p>
                  This is the React Native application that I built while
                  working at the Sparks Lab. It was used to connect to research
                  devices, initiate tests via bluetooth, and recieve and process
                  data.
                </p>
        ...
        >
          ...
          >
            <div className="projectExpandable">
              <div>
                <p>
                  A react project to demonstrate the comparisons made by
                  different sorting algorithms when sorting an array
                </p>
                <a
