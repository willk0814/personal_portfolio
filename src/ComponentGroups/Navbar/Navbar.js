    ...
    <div className='navbarContainer'>
        ...
        <ul className='navbarMenu'>
            <li 
                ...
                <div className='underline' style={{width: educationUnderlined ? '100%' : '0%'}}> 
                </div>
            </li>
            ...
            <li 
                ...
                <div className='underline' style={{width: experienceUnderlined ? '100%' : '0%'}}> 
                </div>
            </li>
            ...
            <li 
                ...
                <div className='underline' style={{width: porjectsUnderlined ? '100%' : '0%'}}> 
                </div>
            </li>
            ...
            <li 
                ...
                <div className='underline' style={{width: contactUnderlined ? '100%' : '0%'}}> 
                </div>
            </li>
        </ul>

        {/* Links on the side */}
        <div className='keyLinksBar'>
            <ul>
                <li className='socialListIcon'>
                    <a href="https://github.com/willk0814" target="_blank" className='socialLink'>
                ...
                <li className='socialListIcon'>
                    <a href="https://www.linkedin.com/in/will-koenig/" target="_blank"           
                ...
                <li className='socialListIcon'>
                    <a href={pdf} download='Koenig_Resume_2023.pdf' className='socialLink'>
                    <div className='socialIcon'>
